...
public class EditMission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etMission = findViewById(R.id.ourMissionET);
        btnSave = findViewById(R.id.editOurMissionBtn);
...
//        });
    ...
    private void updateInfo() {
        ...
        user.put("updateInfo", etMission.getText().toString());

        DocumentReference docRef = db.collection("users").document(FirebaseAuth.getInstance().getCurrentUser().getUid());

        docRef.update("ourMission", user.get("updateInfo"))
        ...
        Intent intent = new Intent(EditMission.this, EmployerEditProfile.class);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    if (doc.exists())
                    {
                        ...
                        etMission.setText(doc.getData().get("ourMission").toString());
